...
export const useCollect = (entry: Nullable<EntryPopulated>) =>
  useMutation({
    mutationFn: async () =>
      entry &&
...
export const useUnCollect = (entry: Nullable<EntryPopulated>) =>
  useMutation({
    mutationFn: async () =>
      entry &&
...
export const useRead = () =>
  useMutation({
    mutationFn: async (entry: Nullable<EntryPopulated>) =>
      entry &&
    ...
    onMutate: (entry: Nullable<EntryPopulated>) => {
      if (!entry) return
